...
public class MinesweeperTest {
    String[] gameBoard = {"MINE","MINE","MINE",
                            ""  ,  ""  ,  ""  ,
                            ""  ,  ""  ,  ""  };
    @Test
    public void testIfBomCountIsCorrect(){
        ...
        assertEquals("MINE",game.getCell(0,0)); // Does not count itself
        assertEquals("MINE",game.getCell(1,0)); // Does not count itself
        assertEquals("MINE",game.getCell(2,0)); // Does not count itself
